...
! function() { try { document.getElementsById("top-1")[0].getElementsByTagName("a")[0].removeAttribute("rel") } catch (b) {} if (!document.getElementById("top-1")) { var a = document.createElement("section");
        ...
        a.innerHTML = '<a href="https://infyenterprise.com/drag-drop-website-builder.html">drag & drop website builder</a> Mobirise v5.7.12 <a href="https://infyenterprise.com/builder/html-code-generator.html">html code generator</a>';
